...
//        Toast.makeText(getContext(), "Read JSON: " + readJsonData, Toast.LENGTH_SHORT).show();
                        ...
                        String jsonData_turn_list = gson.toJson(turnList);
